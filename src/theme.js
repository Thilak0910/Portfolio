...
export const blueTheme = {
  ...
  splashBg: "#001C55",
  // Contact Form Colors
  contactFormBackground: "#FFFFFF",
  inputBackground: "#F5F9FE",
  buttonColor: "#0E6BA8",
  buttonHover: "#0A4F7D",
  disabledButtonColor: "#A0C4D8",
  lightBoxShadow: "#D9E6F2",
};
...
export const brownTheme = {
  ...
  // Contact Form Colors
  contactFormBackground: "#FFFFFF",
  inputBackground: "#FFF9EC",
  buttonColor: "#FB6376",
  buttonHover: "#E05366",
  disabledButtonColor: "#F5A5AD",
  lightBoxShadow: "#F5E8E9",
};
...
export const purpleTheme = {
  ...
  // Contact Form Colors
  contactFormBackground: "#FFFFFF",
  inputBackground: "#F8EFF4",
  buttonColor: "#5E548E",
  buttonHover: "#4A4372",
  disabledButtonColor: "#AEA9C3",
  lightBoxShadow: "#E0D9EB",
};
...
export const greenTheme = {
  ...
  // Contact Form Colors
  contactFormBackground: "#FFFFFF",
  inputBackground: "#F5FFFA",
  buttonColor: "#007f5f",
  buttonHover: "#006348",
  disabledButtonColor: "#7FBFAA",
  lightBoxShadow: "#D9EFE6",
};
...
export const redTheme = {
  ...
  // Contact Form Colors
  contactFormBackground: "#FFFFFF",
  inputBackground: "#FFF8E6",
  buttonColor: "#dc2f02",
  buttonHover: "#B82601",
  disabledButtonColor: "#F09781",
  lightBoxShadow: "#F5E6E5",
};
...
export const blackTheme = {
  ...
  buttonColor: "#14213d",
  buttonHover: "#0E1A31",
  disabledButtonColor: "#8A90A0",
  lightBoxShadow: "#D9D9D9",
};
...
export const pinkTheme = {
  ...
  // Contact Form Colors
  contactFormBackground: "#FFFFFF",
  inputBackground: "#FEE9F2",
  buttonColor: "#ef476f",
  buttonHover: "#D13A5E",
  disabledButtonColor: "#F7A3B7",
  lightBoxShadow: "#F5E1E8",
};
